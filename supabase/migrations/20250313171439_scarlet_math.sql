/*
  # Ajout des exercices de base

  1. Nouvelles Tables
    - `default_exercises` pour stocker les exercices de base
    - Relation avec la table `exercises` existante

  2. Sécurité
    - RLS pour permettre la lecture par tous les coachs
    - RLS pour permettre la copie vers les exercices personnalisés
*/
