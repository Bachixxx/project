...
-- Add policy for anonymous registration check
CREATE POLICY "Allow anonymous registration check"
  ON clients
  FOR SELECT
  TO anon
  USING (true);
...
GRANT EXECUTE ON FUNCTION check_client_registration TO anon;
