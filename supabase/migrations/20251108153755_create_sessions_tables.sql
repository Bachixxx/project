/*
  # Create Sessions and Related Tables
  ...
  1. New Tables
    - `sessions`
      ...
      - Owned by coaches
    - `session_exercises`
      - Junction table linking sessions to exercises
      - Includes instructions field for flexible exercise details
      - Includes rest_time for recovery periods
    - `program_sessions`
      - Junction table linking programs to sessions
  
  2. Security
    - Enable RLS on all tables
    - Coaches can only manage their own sessions
    - Access through programs is controlled by program ownership
*/
