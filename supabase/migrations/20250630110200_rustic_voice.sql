/*
  # Create Sessions and Program Sessions Tables

  1. New Tables
    - `sessions` for storing workout sessions
    - `session_exercises` for linking exercises to sessions
    - `program_sessions` for linking sessions to programs

  2. Security
    - RLS policies for coach-specific data access
