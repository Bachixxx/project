/*
  # Fix client registration function
  
  1. Changes
    - Create a standalone client registration function that doesn't rely on edge functions
    - Grant necessary permissions to authenticated users
  
  2. Security
    - Function uses SECURITY DEFINER to run with elevated privileges
    - Proper permission checks before allowing registration
*/
