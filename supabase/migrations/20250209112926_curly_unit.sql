...
BEGIN
  ...
  DROP POLICY IF EXISTS "Coaches can view their own subscription history" ON subscription_history;
  ...
  DROP POLICY IF EXISTS "Coaches can manage workout sessions for their clients" ON workout_sessions;
