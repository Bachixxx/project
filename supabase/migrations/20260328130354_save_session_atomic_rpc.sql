-- Atomic session save: replaces 4+ sequential Supabase client calls with a single
-- transactional RPC to prevent partial writes (e.g., groups deleted but insert fails).
...
BEGIN
  ...
  IF p_session_id IS NOT NULL THEN
    ...
    -- Delete old children (atomic — same transaction)
