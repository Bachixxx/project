-- First, remove any subscription plan references from coaches
DO $$ 
BEGIN
  UPDATE coaches
...
BEGIN
  ...
  INSERT INTO subscription_plans (
    ...
    'price_1Qp9ZyKjaGJ8zmprMs2hVbte',
    'prod_RialhSXBiFHByN'
  );
  ...
  INSERT INTO subscription_plans (
    ...
    'price_1Qp9asKjaGJ8zmprq2QoGlim',
    'prod_RiamLbgrzgFknW'
  );
END $$;
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    AND stripe_price_id = 'price_1Qp9ZyKjaGJ8zmprMs2hVbte'
  ...
  IF NOT EXISTS (
    SELECT 1 FROM subscription_plans 
    WHERE interval = 'year' 
    AND stripe_price_id = 'price_1Qp9asKjaGJ8zmprq2QoGlim'
