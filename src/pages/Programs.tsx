...
// or defining local ones if they differ slightly (though they should match).
// For safety, I'll use the ones from the hook where possible, or keep local if they are extended.
// The hook exports Program, ProgramSession, Session. 
// However, the local file had SessionExercise which is NOT in the hook.
