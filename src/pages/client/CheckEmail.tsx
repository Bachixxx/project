...
function CheckEmail() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Lier le compte au client ou créer un nouveau client
      ...
      if (!updateData || !updateData.success) {
        console.error("Failed to update/create client:", updateData);
        throw new Error(updateData?.message || "Erreur lors de la création du compte client");
      }
      ...
      <div className="max-w-md w-full glass-card p-8 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 mt-2">
            Créez votre compte pour accéder aux programmes et séances
          </p>
        </div>
