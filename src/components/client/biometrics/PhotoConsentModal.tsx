...
export function PhotoConsentModal({ isOpen, onClose, onConfirm, clientName }: PhotoConsentModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm">
            {/* Mobile Layout: Stretched between Header (h-16) and Footer (h-20) */}
            {/* Desktop Layout: Centered Overlay */}
            <div className="absolute inset-0 top-16 bottom-[5.5rem] md:inset-0 md:top-0 md:bottom-0 flex flex-col md:items-center md:justify-center p-0 md:p-4">
                <div className="w-full h-full md:h-auto md:max-w-lg bg-[#1e293b] md:rounded-2xl border-y md:border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col">
                    ...
                    <div className="p-4 md:p-6 border-t border-white/10 bg-white/5 shrink-0 z-10 pb-4 md:pb-6">
                        <button
