  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-amber-400 hover:bg-amber-500/30 hover:scale-110 transition-all shadow-lg backdrop-blur-sm"
